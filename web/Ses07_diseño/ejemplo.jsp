...
<html>
   <head>
      ...
      <script src="<%=request.getContextPath()%>/Ses07_diseño/js/juery_personal.js"></script>
      <script src="<%=request.getContextPath()%>/Ses07_diseño/js/boostrap.min.js"></script>
         ...
         <nav class="navbar navbar-default" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-exl-collapse">
               ...
               <ul class="nav navbar-nav">
                  <li class="dropdown">
                     <a href="#">
                        <img src="<%= request.getContextPath()%>/Ses07_diseño/imagenes/main.png" alt="Principal"/>Principal
                     </a>
                  </li>
               </ul>
               ...
               <div id="carousel1" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                     <div class="item-active">
                        <img src="imagenes/principal3.png" width="100%" height="100%" alt="" src="<%=request.getContextPath()%>/Ses07_diseño/imagenes/principal2.png"/>
